...
Voimme ratkaista tehtävän tehokkaasti järjestämisen avulla, koska pienin etäisyys on kahden sellaisen luvun välillä, jotka ovat vierekkäin järjestetyssä listassa. Tämän ansiosta pienin ero voidaan löytää järjestämisen jälkeen käymällä listan luvut läpi ja vertailemalla vierekkäisiä lukuja. Esimerkiksi lista $$[4,1,7,3,9]$$ on järjestettynä $$[1,3,4,7,9]$$, jolloin pienimmän eron luvut $$3$$ ja $$4$$ ovat vierekkäin.
