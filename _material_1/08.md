...
print(components) # {1: 1, 2: 1, 3: 2, 4: 2, 5: 2}
```
...
print(d.find_distances()) # {1: 0, 2: 1, 3: 1, 4: 1, 5: 2}
```
...
Leveyshaun avulla voimme myös rakentaa luokan, jolla voi selvittää lyhimmän polun kahden solmun välillä:
...
s.find_path(2, 4) # [2, 4]
s.find_path(1, 5) # [1, 2, 5]
s.find_path(5, 1) # [5, 2, 1]
```
