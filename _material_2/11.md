...
Pakka on toteutettu Pythonissa [linkitettynä listana](../linkitetty-lista), jonka ansiosta on mahdollista lisätä ja poistaa alkioita tehokkaasti sekä listan alussa että lopussa.
...
_Keko_ (_heap_) on tietorakenne, jossa voi lisätä, hakea ja poistaa alkioita. Kekoon voi lisätä mitä tahansa alkioita, mutta siitä voi hakea ja poistaa vain pienimmän tai suurimman alkion, riippuen keon toteutuksesta.
