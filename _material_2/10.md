...
Huomaa, että koska yksi kolikoista on aina arvoltaan $$1$$, kaikki summat $$0 \dots x$$ voidaan muodostaa kolikoista. Silmukassa kohtaan `result[s]` asetetaan alkuarvo `s`, mikä vastaa ratkaisua, jossa jokainen kolikko on $$1$$.
...
Ratkaisun muodostaminen voidaan toteuttaa tallentamalla jokaiselle summalle $$0 \dots x$$ lista kolikoista, joilla summa voidaan muodostaa ja jossa kolikoiden määrä on mahdollisimman pieni. Tämä voidaan toteuttaa seuraavasti:
